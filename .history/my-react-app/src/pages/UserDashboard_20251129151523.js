  ...
  return (
    <div className="dashboard-bg">
      ...
      <div className="premium-container">
        ...
        {/* If result exists, show two-column grid: upload left, report right */}
        {result ? (
          <div className="container-grid">
            <div className="upload-card pop-in">
          ...
          /* No result yet: show centered upload card */
          <div className="upload-card pop-in">
            { /* upload block content (duplicated) */ }
            <h3 className="card-title">Upload X-Ray</h3>
